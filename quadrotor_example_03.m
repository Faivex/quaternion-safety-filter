...
plotSafetyResults(time, x_safe, x_unsafe, u_safe, u_unsafe, pos_des, q_v_max, u_max, P, h_min, h_max, 'results/quadrotor_example_03');

% Plot results comparing both scenarios
% plotResults(time, x_safe, x_unsafe, u_safe, u_unsafe, w, d_max, P, alpha_fun, ...
%            u_max, x_max, pos_des, 'results/quadrotor_example_03');
